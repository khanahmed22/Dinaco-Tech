              ...
              <Tab>
                ...
                >
                  <div className="flex gap-2 items-center">
                    <ion-icon name="pricetags"></ion-icon> Products
                  </div>{" "}
                </button>
              </Tab>
              <Tab>
                ...
                >
                  <div className="flex gap-2 items-center">
                    <ion-icon name="bag-handle"></ion-icon> Orders
                  </div>
                </button>
              </Tab>
              <Tab>
                ...
                >
                  <div className="flex gap-2 items-center">
                    <ion-icon name="person"></ion-icon> Users
                  </div>
                </button>
              </Tab>
            </TabList>
              ...
              <div className="  px-4 md:px-0 mb-16">
                ...
                <div className=" flex justify-end">
                  ...
                  >
                    {" "}
                    <div className="flex gap-2 items-center">
                      <ion-icon size="large" name="add"></ion-icon> Add Product
                    </div>
                  </button>
                </div>
